 ...
 * O Objetivo da class � receber requisi��o http e convertela em object para class MaterialRepository
 * Data 16/11/2018
...
public class MaterialController extends HttpServlet{
	...
	/**
	 * Metodo doGet recebe requisi��o http e converte em object para class MaterialReposytory.
	 * A requisi��o http vem no formato JSON.
	...
	/**
	 * Metodo doPost recebe requisi��o http e converte em object para class MaterialReposytory.
	 * A requisi��o http vem no formato JSON.
	 * Data 16/11/2018
	 * @param le o formato json com JsonUtil converte com gson e envia para MaterialRepository.
	 * @return resp.getWriter().print()
	...
	if (materialRepository.adicionaMaterial(material)) {
		...
		//	req.setAttribute("mensagem", "Material salvo com sucesso!");
