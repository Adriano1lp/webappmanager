...
/**
 * Servlet implementation class ReparoHistoricoController
 */
@WebServlet("/reparohistorico")
public class ReparoHistoricoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		reparoRepository.selectReparoPesquisa();
	}
}
